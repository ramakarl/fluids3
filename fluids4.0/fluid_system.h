...
//-----------------------------------------------------------------------------
	...
	public:
		...
		Vector3DF* getPos ( int n )		{ return &m_Fluid.bufF3(FPOS)[n]; }
		Vector3DF* getVel ( int n )		{ return &m_Fluid.bufF3(FVEL)[n]; }
		...
		int getMode ()		{ return (int) m_Params.mode; }
